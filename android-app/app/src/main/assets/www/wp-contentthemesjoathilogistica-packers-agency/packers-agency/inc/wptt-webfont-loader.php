...
if ( ! class_exists( 'Packers_Agency_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Packers_Agency_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$packers_agency_contents = wp_remote_retrieve_body( $response );

			return $packers_agency_contents;
		}
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Packers_Agency_WPTT_WebFont_Loader( $url );
