...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
	 ...
	 <?php
		    ...
		    $packers_agency_post_id = get_the_ID(); // Add this line to get the post ID
		    $packers_agency_single_content_setting = get_post_gallery();

		    if (!empty($packers_agency_single_content_setting)) {
		        // Display the gallery
		        echo '<div class="embedded-gallery">' . do_shortcode($packers_agency_single_content_setting) . '</div>';
		    }
		?>
    <?php
